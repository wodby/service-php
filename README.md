# PHP service for Wodby

Use PHP as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public PHP service in the Wodby catalog.

- [PHP service in the Wodby catalog](https://wodby.com/services/php)
...
4. Reference `php` from your stack manifest.
